...
__global__ void Kernel(float4_t* output, float4_t* input) {
    ...
    int out_id1 = blockIdx.y * n * h * w + blockIdx.z * h * w + threadIdx.x * c;
    int out_id2 = out_id1 + n * h * w;
    int out_id3 = out_id2 + n * h * w;
    int out_id4 = out_id3 + n * h * w;
...
// threadIdx.x + blockIdx.y * n * h * w + blockIdx.z * h * w
s_mul_i32 s8, s6, 64*64*64
s_mul_i32 s9, s7, 64*64
s_add_i32 s9, s8, s9
v_add_u32 v2, v0, s9
...
v_add_co_u32 v11, vcc, v9, 64*64*64
v_addc_co_u32 v12, vcc, v10, 0, vcc

v_add_co_u32 v13, vcc, v11, 64*64*64
v_addc_co_u32 v14, vcc, v12, 0, vcc

v_add_co_u32 v15, vcc, v13, 64*64*64
v_addc_co_u32 v16, vcc, v14, 0, vcc

s_waitcnt vmcnt(0)

flat_store_dword v5, v[9:10]
flat_store_dword v6, v[11:12]
flat_store_dword v7, v[13:14]
flat_store_dword v8, v[15:16]
    s_endpgm
.Lfunc_end0:
